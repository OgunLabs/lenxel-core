...
class LNX_Elementor_Override{
   ...
   public function column_style( $obj, $args ) {
      $obj->start_controls_section(
         'lnx_column_style',
         array(
            'label' => esc_html__( 'Lenxel Style Settings', 'lenxel-plugin' ),
      ...
      $obj->add_control(
         '_lnx_extra_classes',
         [
            'label' => __( 'Style Available', 'lenxel-plugin' ),
            'type' => Controls_Manager::SELECT,
            'options' => [
               '' => __( '-- None --', 'lenxel-plugin' ),
               'bg-overflow-left' => __( 'Background Overflow Left', 'lenxel-plugin' ),
               'bg-overflow-right' => __( 'Background Overflow Right', 'lenxel-plugin' ),
            ],
            'default' => 'top',
   ...
   public function after_row_end( $obj, $args ) {
      ...
      $obj->start_controls_section(
         'lnx_section_row',
         array(
            'label' => esc_html__( 'Lenxel Extra Settings Row for Header Builder', 'lenxel-plugin' ),
      ...
      $obj->add_control(
         'row_header_sticky',
         [
            'label'  => esc_html__( 'Sticky Row Settings (Use only for row in header)', 'lenxel-plugin' ),
      ...
      $obj->add_control(
         '_lnx_sticky_menu',
         [
            'label'     => __( 'Sticky Menu Row', 'lenxel-plugin' ),
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               '' => __( '-- None --', 'lenxel-plugin' ),
               'gv-sticky-menu' => __( 'Sticky Menu', 'lenxel-plugin' ),
            ],
            'default'         => '',
            'prefix_class'    => '',
            'description'     => __('You can only enable sticky menu for one row, please make sure display all sticky menu for other rows', 'lenxel-plugin')
         ]
      );
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Background Color', 'lenxel-plugin'),
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Text Color', 'lenxel-plugin'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Link Menu Color', 'lenxel-plugin'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Link Menu Hover Color', 'lenxel-plugin'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
   ...
   public function row_style($obj, $args){
      ...
      $obj->add_control(
         ...
         [
            ...
            'options'   => [
               '' => __( '-- None --', 'lenxel-plugin' ),
               'style-1' => __( 'Background White Full To Left and Border Theme', 'lenxel-plugin' ),
               'style-2' => __( 'Background Theme Full To Right', 'lenxel-plugin' ),
            ],
            'label_block'  => true,
            'default'      => 'top',
            'prefix_class' => 'row-',
      ...
      $obj->add_control(
         ...
         [
            ...
            'label_block'  => true,
            'options' => [
               '' => __( '-- Default --', 'lenxel-plugin' ),
               'theme'         => __( 'Background Color Theme', 'lenxel-plugin' ),
               'theme-second'  => __( 'Background Color Theme Second', 'lenxel-plugin' ),
            ],
            'default' => '',
            'prefix_class' => 'bg-row-',
         ]
      ...
      $obj->add_control(
         'lnx_bg_row_effect',
         [
            'label' => __( 'Background Effect', 'lenxel-plugin' ),
            'type' => Controls_Manager::SELECT,
            'label_block'  => true,
            'options' => [
               '' => __( '-- Default --', 'lenxel-plugin' ),
               'particles-js'  => __( 'Particles', 'lenxel-plugin' )
            ],
            'default' => '',
   ...
   public function icon_box( $obj, $args ) {
      $obj->start_controls_section(
         ...
         array(
            'label' => esc_html__( 'LNX Theme Settings', 'lenxel-plugin' ),
      ...
      $obj->add_control(
         ...
         [
            ...
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               ''             => esc_html__( '-- Default --', 'lenxel-plugin' ),
