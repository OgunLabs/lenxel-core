...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	$this->add_render_attribute(['wrapper'=>['class'=> 'lnx-gallery-carousel'], 'carousel'=> ['class'=> 'init-carousel-owl owl-carousel slider-fade']]);
	$_random = lenxel_themesupport_random_id();
?>
 
	<div <?php $this->print_render_attribute_string('wrapper'); ?>>
		<div <?php $this->print_render_attribute_string('carousel'); ?> data-items="1" data-items_lg="1" data-items_md="1" data-items_sm="1" data-items_xs="1" data-items_xx="1" data-loop="1" data-speed="800" data-auto_play="1" data-auto_play_speed="800" data-auto_play_timeout="6000" data-auto_play_hover="1" data-navigation="0" data-pagination="0" data-mouse_drag="1" data-touch_drag="1">
			<?php
