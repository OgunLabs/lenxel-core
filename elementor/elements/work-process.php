...
class LNXElement_Work_Process extends LNXElement_Base {  
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'LNX Work Process', 'lenxel-core' ),
			]
		);
		...
		$this->add_responsive_control(
			'box_padding',
			[
				'label' => __( 'Box Padding', 'lenxel-core' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'default' => [
					'top' 		=> 50,
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your number', 'lenxel-core' ),
			]
		);
		...
		$this->start_controls_section( //** Section Button
			'section_line',
			[
				'label' => __( 'Line', 'lenxel-core' ),
			]
		);
		$this->add_control(
			'line_left',
			[
				'label' => __( 'Display Line Left', 'lenxel-core' ),
		...
		$this->add_control(
			'line_right',
			[
				'label' => __( 'Display Line Right', 'lenxel-core' ),
				'type'      => Controls_Manager::SWITCHER,
            'default'   => 'yes',
			]
		);
		$this->add_control(
			'line_background',
			[
				'label' => __( 'Line Background', 'lenxel-core' ),
				'type' => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .gsc-work-process .box-content .box-background' => 'background-color: {{VALUE}};',
		...
		$this->add_responsive_control(
			'icon_box_width',
			[
				'label' => __( 'Icon Box Width', 'lenxel-core' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 105,
				],
