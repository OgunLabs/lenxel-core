...
class LNXElement_Course_category extends LNXElement_Base {
	...
	public function get_title() {
		$get_current_name = load_lenxel_widget_content_element('LNX Category');
	...
	protected function register_controls(){
      ...
      $this->add_control(
         'category_per_page',
         [
            'label' => __( 'Category Per Page', 'lenxel-plugin' ),
      ...
      $this->add_control_grid(array('layout' => 'grid'));
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Overlay Color', 'lenxel-plugin' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'box_space',
			[
				'label' => __( 'Card Element Space Bottom', 'lenxel-plugin' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 26,
				],
		...
		$this->add_responsive_control(
			'box_space_divider',
			[
				'label' => __( 'Card Element Space Divider', 'lenxel-plugin' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 3,
				],
		...
		$this->add_responsive_control(
			'box_contain_width',
			[
				'label' => __( 'Card container width', 'lenxel-plugin' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 100,
				],
		...
		$this->add_responsive_control(
			'box_space_card',
			[
				'label' => __( 'Card Padding Spacing', 'lenxel-plugin' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px'],
				'default' => [
				  'top'       => 90,
