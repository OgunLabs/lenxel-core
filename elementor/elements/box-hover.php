...
class LNXElement_Box_Hover extends LNXElement_Base{
    ...
    public function get_title() {
        return __('LNX Box Hover', 'lenxel-plugin');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => 'style-1',
                'options' => [
                  'style-1' => esc_html__('Style I - Carousel', 'lenxel-plugin'),
                ]
            )
         );
        ...
        $this->add_control(
            'content_items',
            [
                'label'       => __('Content Item', 'lenxel-plugin'),
                ...
                'default'     => array(
                    array(
                        ...
                        'box_content'  => esc_html__( 'There are many variations of passages of available but the majority have suffered alter randomised words.', 'lenxel-plugin' ),
                    ),
                    array(
        ...
        $this->add_control(
            'box_height',
            [
                'label'      => __('Box Height', 'lenxel-plugin'),
        ...
        $this->add_control(
            'icon_background',
            [
                'label'     => __('Icon Background Color', 'lenxel-plugin'),
        ...
        $this->add_control(
            'icon_border_radius',
            [
                'label'      => __('Icon Border Radius', 'lenxel-plugin'),
