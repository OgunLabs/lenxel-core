  ...
  protected function add_control_carousel($single_item, $condition = array()) {
	...
	public function get_template( $template_name = null ){
  	...
  	public function pagination( $query = false ){
	 	...
	 	$translate['prev'] =  esc_html__('Prev page', 'lenxel-theme-support');
	 	$translate['next'] =  esc_html__('Next page', 'lenxel-theme-support');
	 	$translate['load-more'] = esc_html__('Load more', 'lenxel-theme-support');
