...
class LNXElement_Posts extends LNXElement_Base{
    ...
    public function get_title() {
        return __('LNX Posts', 'lenxel-plugin');
    }
    ...
    protected function register_controls() {
         ...
         $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'small_list'    => __( 'Small List', 'lenxel-plugin' ),
                    'sticky'        => __( 'Post Large & List', 'lenxel-plugin' )
                ]
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'post-style-1'         => __( 'Item Post Style I', 'lenxel-plugin' ),
                    'post-style-2'         => __( 'Item Post Style II', 'lenxel-plugin' ),
                ],
                'condition' => [
        ...
        $this->add_control(
            'image_size',
            [
               'label'     => __('Image Style', 'lenxel-plugin'),
               'type'      => \Elementor\Controls_Manager::SELECT,
        ...
        $this->add_control(
         'excerpt_words',
         [
            'label'     => __('Excerpt Words', 'lenxel-plugin'),
            'type'      => 'number',
            'default'   => 15
         ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Right List Posts Style', 'lenxel-plugin' ),
        ...
        $this->add_responsive_control(
            'stick_list_padding',
            [
                'label' => __( 'Padding List Posts', 'lenxel-plugin' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Background List Posts', 'lenxel-plugin' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'List Posts Title Color', 'lenxel-plugin' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'List Posts Meta Color', 'lenxel-plugin' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Content', 'lenxel-plugin' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_responsive_control(
            'post_box_padding',
            [
                'label' => __( 'Padding Post Content', 'lenxel-plugin' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
        ...
        $this->add_control(
            'post_box_background',
            [
                'label' => __( 'Background Post Content', 'lenxel-plugin' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Title', 'lenxel-plugin' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Color Title', 'lenxel-plugin' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Color Title Hover', 'lenxel-plugin' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Description', 'lenxel-plugin' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'layout' => ['grid', 'carousel']
                ],
