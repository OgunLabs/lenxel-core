...
class Updater {
	...
	public function run_theme_hooks() {
		add_filter( 'pre_set_site_transient_update_themes', array( $this, 'check_theme_update_lenxel' ) );
	}

	/**
	 * Check for Update for this specific project
	 */
	public function check_plugin_update_lenxel( $transient_data ) {
		global $pagenow;
	 ...
	 * @return object $data
	 */
	public function plugins_api_filter_lenxel( $data, $action = '', $args = null ) {
	 ...
	 * Check theme upate
	 */
	public function check_theme_update_lenxel( $transient_data ) {
		global $pagenow;
