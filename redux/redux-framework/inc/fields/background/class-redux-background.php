		...
		public function render() {
			...
			if ( $this->field['background-image'] ) {
				if ( true === $this->field['background-repeat'] ) {
					$array = array(
						'no-repeat' => esc_html__( 'No Repeat', 'lenxel-theme-support' ),
						'repeat'    => esc_html__( 'Repeat All', 'lenxel-theme-support' ),
						'repeat-x'  => esc_html__( 'Repeat Horizontally', 'lenxel-theme-support' ),
						'repeat-y'  => esc_html__( 'Repeat Vertically', 'lenxel-theme-support' ),
						'inherit'   => esc_html__( 'Inherit', 'lenxel-theme-support' ),
					);

					echo '<select id="' . esc_attr( $this->field['id'] ) . '-repeat-select" data-placeholder="' . esc_html__( 'Background Repeat', 'lenxel-theme-support' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-repeat]" class="redux-select-item redux-background-input redux-background-repeat ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
					echo '<option></option>';
				...
				if ( true === $this->field['background-clip'] ) {
					$array = array(
						'inherit'     => esc_html__( 'Inherit', 'lenxel-theme-support' ),
						'border-box'  => esc_html__( 'Border Box', 'lenxel-theme-support' ),
						'content-box' => esc_html__( 'Content Box', 'lenxel-theme-support' ),
						'padding-box' => esc_html__( 'Padding Box', 'lenxel-theme-support' ),
					);

					echo '<select id="' . esc_attr( $this->field['id'] ) . '-clip-select" data-placeholder="' . esc_html__( 'Background Clip', 'lenxel-theme-support' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-clip]" class="redux-select-item redux-background-input redux-background-clip ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
					echo '<option></option>';
				...
				if ( true === $this->field['background-origin'] ) {
					...
					echo '<select id="' . esc_attr( $this->field['id'] ) . '-origin-select" data-placeholder="' . esc_html__( 'Background Origin', 'lenxel-theme-support' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-origin]" class="redux-select-item redux-background-input redux-background-origin ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
					echo '<option></option>';
				...
				if ( true === $this->field['background-size'] ) {
					$array = array(
						'inherit' => esc_html__( 'Inherit', 'lenxel-theme-support' ),
						'cover'   => esc_html__( 'Cover', 'lenxel-theme-support' ),
						'contain' => esc_html__( 'Contain', 'lenxel-theme-support' ),
					);

					echo '<select id="' . esc_attr( $this->field['id'] ) . '-size-select" data-placeholder="' . esc_html__( 'Background Size', 'lenxel-theme-support' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-size]" class="redux-select-item redux-background-input redux-background-size ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
					echo '<option></option>';
				...
				if ( true === $this->field['background-attachment'] ) {
					$array = array(
						'fixed'   => esc_html__( 'Fixed', 'lenxel-theme-support' ),
						'scroll'  => esc_html__( 'Scroll', 'lenxel-theme-support' ),
						'inherit' => esc_html__( 'Inherit', 'lenxel-theme-support' ),
					);

					echo '<select id="' . esc_attr( $this->field['id'] ) . '-attachment-select" data-placeholder="' . esc_html__( 'Background Attachment', 'lenxel-theme-support' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-attachment]" class="redux-select-item redux-background-input redux-background-attachment ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
					echo '<option></option>';
				...
				if ( true === $this->field['background-position'] ) {
					$array = array(
						'left top'      => esc_html__( 'Left Top', 'lenxel-theme-support' ),
						'left center'   => esc_html__( 'Left center', 'lenxel-theme-support' ),
						'left bottom'   => esc_html__( 'Left Bottom', 'lenxel-theme-support' ),
						'center top'    => esc_html__( 'Center Top', 'lenxel-theme-support' ),
						'center center' => esc_html__( 'Center Center', 'lenxel-theme-support' ),
						'center bottom' => esc_html__( 'Center Bottom', 'lenxel-theme-support' ),
						'right top'     => esc_html__( 'Right Top', 'lenxel-theme-support' ),
						'right center'  => esc_html__( 'Right center', 'lenxel-theme-support' ),
						'right bottom'  => esc_html__( 'Right Bottom', 'lenxel-theme-support' ),
					);

					echo '<select id="' . esc_attr( $this->field['id'] ) . '-position-select" data-placeholder="' . esc_html__( 'Background Position', 'lenxel-theme-support' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-position]" class="redux-select-item redux-background-input redux-background-position ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
					echo '<option></option>';
			...
			if ( $this->field['background-image'] ) {
				...
				$placeholder = $this->field['placeholder'] ?? esc_html__( 'No media selected', 'lenxel-theme-support' );

				echo '<input placeholder="' . esc_html( $placeholder ) . '" type="text" class="redux-background-input ' . esc_attr( $hide ) . 'upload ' . esc_attr( $this->field['class'] ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-image]" id="' . esc_attr( $this->parent->args['opt_name_triger'] ) . '[' . esc_attr( $this->field['id'] ) . '][background-image]" value="' . esc_url( $this->value['background-image'] ) . '" />';
				echo '<input type="hidden" class="upload-id ' . esc_attr( $this->field['class'] ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[media][id]" id="' . esc_attr( $this->parent->args['opt_name_triger'] ) . '[' . esc_attr( $this->field['id'] ) . '][media][id]" value="' . esc_attr( $this->value['media']['id'] ) . '" />';
				echo '<input type="hidden" class="upload-height" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[media][height]" id="' . esc_attr( $this->parent->args['opt_name_triger'] ) . '[' . esc_attr( $this->field['id'] ) . '][media][height]" value="' . esc_attr( $this->value['media']['height'] ) . '" />';
				echo '<input type="hidden" class="upload-width" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[media][width]" id="' . esc_attr( $this->parent->args['opt_name_triger'] ) . '[' . esc_attr( $this->field['id'] ) . '][media][width]" value="' . esc_attr( $this->value['media']['width'] ) . '" />';
				echo '<input type="hidden" class="upload-thumbnail" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[media][thumbnail]" id="' . esc_attr( $this->parent->args['opt_name_triger'] ) . '[' . esc_attr( $this->field['id'] ) . '][media][thumbnail]" value="' . esc_url( $this->value['media']['thumbnail'] ) . '" />';
				...
				echo '<span class="button redux-background-upload" id="' . esc_attr( $this->field['id'] ) . '-media">' . esc_html__( 'Upload', 'lenxel-theme-support' ) . '</span>';
				...
				echo '<span class="button removeCSS redux-remove-background' . esc_attr( $hide ) . '" id="reset_' . esc_attr( $this->field['id'] ) . '" rel="' . esc_attr( $this->field['id'] ) . '">' . esc_html__( 'Remove', 'lenxel-theme-support' ) . '</span>';
