	...
	class Redux_Gradient_Filters {
		...
		public static function render_select( array $data ): string {
			...
			if ( $field['gradient-type'] ) {
				...
				$output .= '<strong>' . esc_html__( 'Gradient Type ', 'lenxel-theme-support' ) . '</strong>&nbsp;';
				$output .= '<select ';
				$output .= 'class="redux-gradient-select select2-container"';
				$output .= 'data-placeholder="' . esc_attr__( 'Type', 'lenxel-theme-support' ) . '" ' . $select2_data . ' ';
				...
				$arr = array(
					esc_html__( 'linear', 'lenxel-theme-support' ),
					esc_html__( 'radial', 'lenxel-theme-support' ),
				);
		...
		public static function render_sliders( array $data ): string {
			...
			if ( $field['gradient-reach'] ) {
				...
				$output .= '<label>' . esc_html__( 'From Reach ', 'lenxel-theme-support' ) . ':  <strong>' . esc_html( $value['gradient-reach']['from'] ) . '%</strong></label>';
				$output .= '<div ';
				...
				$output .= 'data-label="' . esc_attr__( 'From Reach', 'lenxel-theme-support' ) . '"';
				...
				$output .= '<label>' . esc_html__( 'To Reach', 'lenxel-theme-support' ) . ':  <strong>' . esc_html( $value['gradient-reach']['to'] ) . '%</strong></label>';
				$output .= '<div ';
				...
				$output .= 'data-step="1"';
				$output .= 'data-rtl="' . esc_attr( is_rtl() ) . '"';
				$output .= 'data-label="' . esc_attr__( 'To Reach', 'lenxel-theme-support' ) . '"';
			...
			if ( $field['gradient-angle'] ) {
				...
				$output .= '<label>' . esc_html__( 'Gradient Angle', 'lenxel-theme-support' ) . ':  <strong>' . $value['gradient-angle'] . '&deg;</strong></label>';
				$output .= '<div ';
				...
				$output .= 'data-step="1"';
				$output .= 'data-rtl="' . esc_attr( is_rtl() ) . '"';
				$output .= 'data-label="' . esc_attr__( 'Gradient Angle', 'lenxel-theme-support' ) . '"';
