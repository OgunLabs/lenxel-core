		...
		public function render() {
			...
			if ( false === $this->field['simple'] ) {
				...
				echo '          <a
                                    ...
                                    class="redux-save-scheme-button button-secondary">' . esc_html__( 'Add', 'lenxel-core' ) . '
                                </a>';
				...
				echo '          <a
                                    ...
                                    class="redux-delete-scheme-button button-secondary">' . esc_html__( 'Delete', 'lenxel-core' ) . '
                                </a>';
				...
				echo '          <a
                                    ...
                                    class="redux-export-scheme-button button-primary">' . esc_html__( 'Export', 'lenxel-core' ) . '
                                </a>';
				...
				echo '          <a
                                    ...
                                    class="noUpdate redux-import-scheme-button button-secondary">' . esc_html__( 'Import', 'lenxel-core' ) . '
                                </a>';
