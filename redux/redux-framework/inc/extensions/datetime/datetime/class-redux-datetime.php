...
if ( ! class_exists( 'Redux_Datetime', false ) ) {
	...
	class Redux_Datetime extends Redux_Field {
		...
		public function render() {
			...
			if ( true === $split ) {
				$date_placeholder = $this->field['placeholder']['date'] ?? esc_html__( 'Date', 'lenxel-core' );
				$time_placeholder = $this->field['placeholder']['time'] ?? esc_html__( 'Time', 'lenxel-core' );
			} else {
				$date_placeholder = $this->field['placeholder'] ?? esc_html__( 'Date / Time', 'lenxel-core' );
			}
