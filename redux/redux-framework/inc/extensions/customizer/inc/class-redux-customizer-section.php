...
class Redux_Customizer_Section extends WP_Customize_Section {
	...
	protected function render_fallback() {
		...
		<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="<?php echo esc_attr( $classes ); ?>">
			<h3 class="accordion-section-title" tabindex="0">
				...
				?>
				<span class="screen-reader-text"><?php esc_attr_e( 'Press return or enter to expand', 'lenxel-plugin' ); ?></span>
			</h3>
	...
	protected function render_template() {
		...
		<li id="accordion-section-{{ data.id }}"
			...
			<h3 class="accordion-section-title" tabindex="0">
				{{ data.title }}
				<span class="screen-reader-text"><?php esc_html_e( 'Press return or enter to open', 'lenxel-plugin' ); ?></span>
			</h3>
			<ul class="accordion-section-content redux-main">
				...
				<li class="customize-section-description-container">
					<div class="customize-section-title">
						<button class="customize-section-back" tabindex="-1">
							<span class="screen-reader-text"><?php esc_html_e( 'Back', 'lenxel-plugin' ); ?></span>
						</button>
						<h3>
