...
if ( !class_exists('Puc_v4p9_Plugin_UpdateChecker', false) ):
	...
	class Puc_v4p9_Plugin_UpdateChecker extends Puc_v4p9_UpdateChecker {
		...
		public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
			...
			add_filter($slugCheckFilter, array($this, 'getAbsolutePathLenxel'));
		...
		protected function installHooks(){
			...
			add_filter('plugins_api', array($this, 'injectInfoLenxel'), 20, 3);
		...
		public function removeHooks() {
			...
			remove_filter('plugins_api', array($this, 'injectInfoLenxel'), 20);
		}
		 ...
		 * @return mixed
		 */
		public function injectInfoLenxel($result, $action = null, $args = null){
		 ...
		 * @return string
		 */
		public function getAbsolutePathLenxel() {
