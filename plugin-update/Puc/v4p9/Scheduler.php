...
if ( !class_exists('Puc_v4p9_Scheduler', false) ):
	...
	class Puc_v4p9_Scheduler {
		...
		public function __construct($updateChecker, $checkPeriod, $hourlyHooks = array('load-plugins.php')) {
			...
			if ( $this->checkPeriod > 0 ){
				...
				if ( array_key_exists($this->checkPeriod, $defaultSchedules) ) {
					...
					add_filter('cron_schedules', array($this, '_addLenxelCustomSchedule'));
				}
		 ...
		 * @return array
		 */
		public function _addLenxelCustomSchedule($schedules) {
		...
		public function removeHooks() {
			remove_filter('cron_schedules', array($this, '_addLenxelCustomSchedule'));
