...
if ( !class_exists('Puc_v4p9_DebugBar_Extension', false) ):
	...
	class Puc_v4p9_DebugBar_Extension {
		...
		public function __construct($updateChecker, $panelClass = null) {
			...
			add_filter('debug_bar_panels', array($this, 'addDebugBarPanelLenxel'));
			add_action('debug_bar_enqueue_scripts', array($this, 'enqueuePanelDependenciesLenxel'));
		 ...
		 * @return array
		 */
		public function addDebugBarPanelLenxel($panels) {
		 ...
		 */
		public function enqueuePanelDependenciesLenxel() {
			wp_enqueue_style(
		...
		public function removeHooks() {
			remove_filter('debug_bar_panels', array($this, 'addDebugBarPanelLenxel'));
			remove_action('debug_bar_enqueue_scripts', array($this, 'enqueuePanelDependenciesLenxel'));
